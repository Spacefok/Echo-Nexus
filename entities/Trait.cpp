...
std::string Trait::getName() const { return name_; }

std::string Trait::getDescription() const { return description_; }

float Trait::getEffectMultiplier() const { return effectMultiplier_; }
