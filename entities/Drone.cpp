...
int Drone::getHealth() const { return health_; }

int Drone::getMaxHealth() const { return maxHealth_; }

void Drone::setHealth(int health) { health_ = (health > maxHealth_ ? maxHealth_ : health); }

float Drone::getSpeed() const { return speed_; }

std::shared_ptr<Faction> Drone::getFaction() const { return faction_; }
